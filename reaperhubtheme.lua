...
do 
	...
	local GUI1 = game:GetService("CoreGui"):FindFirstChild("Reaper_Hub_ScreenGui")
	if GUI1 then 
		GUI1:Destroy()
	end
end
...
function Creator.GetThemeProperty(Property)
	...
	return Themes["Reaper Hub"][Property]
end
...
local InterfaceManager = {} do
	InterfaceManager.Folder = "Reaper_Hub_Config"
...
function Library:CreateWindow(Config)
	...
	Library.Theme = Config.Theme or "Reaper Hub"
